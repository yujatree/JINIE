...
998	format(A,I5,A)
	...
	open(100, file='CDDF_S.out', status='unknown')
	...
	print*, " Hop traj :", hop_traj
        ...
        allocate(D_eq(nsurr,bin), D_h(nsurr,bin)) ! 1st, 2nd, 3rd, 4th, 5th coordinated S
	   ...
	   do i=1, hop_traj
	      ...
	      do j=1, num_Li!==============================================
	   	 ...
	   	 count_h=count_h+1
	            ...
	            do l=1,nsurr  ! only coordinated S
